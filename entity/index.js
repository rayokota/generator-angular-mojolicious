...
EntityGenerator.prototype.files = function files() {
  ...
  this.version = this.generatorConfig.version + 1;
  ...
  this.generatorConfig.version = this.version;
  ...
  this.template('../../app/templates/lib/_App.pm', libDir + _s.capitalize(this.baseName) + '.pm');
  this.template('../../app/templates/lib/_Schema.pm', libDir + 'Schema.pm');
  this.template('_generator.json', 'generator.json');
  this.template('lib/_App/_Entities.pm', libDir + _s.capitalize(this.baseName) + '/' + _s.capitalize(pluralize(this.name)) + '.pm');
  this.template('lib/Schema/Result/_Entity.pm', schemaResultDir + _s.capitalize(this.name) + '.pm');
  this.template('lib/Schema/ResultSet/_Entity.pm', schemaResultSetDir + _s.capitalize(this.name) + '.pm');
